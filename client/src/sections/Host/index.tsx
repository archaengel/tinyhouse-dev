...
const beforeImageUpload = (file: File) => {
  ...
  if (!fileIsValidSize) {
    displayErrorMessage(
      "You're only able to upload valid image files under 1MB in size"
    );
    return false;
  }
...
export const Host = ({ viewer, form }: Props & FormComponentProps) => {
  ...
  >(HOST_LISTING, {
    onError: () => {
      displayErrorMessage(
        "Sorry! We weren't able to create your listing. Please try again soon!"
      );
    },
    onCompleted: () => {
      ...
      <Content className="host-content">
        <div className="host__form-header">
          ...
          <Text type="secondary">
            ...
            connected with Strip to host new listings. You can sign in at the{' '}
      ...
      <Form layout="vertical" onSubmit={handleHostListing}>
        ...
        <Item label="Home Type">
          {getFieldDecorator('type', {
            rules: [
              { required: true, message: 'Please select a listing type!' }
            ]
          })(
            <Radio.Group>
        ...
        <Item label="Description of Listing" extra="Max character count of 400">
          {getFieldDecorator('description', {
            ...
            <Input.TextArea
              rows={3}
              maxLength={400}
              placeholder="Modern, clean, and iconic home of the Fresh Prince. Situated in the heard of Bel-Air, Los Angeles."
            />
          )}
        </Item>
        ...
        <Item label="Zip/Postal Code">
          {getFieldDecorator('postalCode', {
            rules: [
              {
                required: true,
                message: 'Pleae enter a zip code for your listing!'
              }
            ]
        ...
        <Item label="Price" extra="All prices in $USD/day">
          {getFieldDecorator('price', {
            rules: [
              {
                required: true,
                message: 'Please enter a price four your listing!'
              }
            ]
